...
okf_version: 0.1
type: knowledge-node
title: "Pengurusan Storan, Partisi & Sistem Fail Linux"
timestamp: "2026-08-17T00:00:00Z"
topics: ["noss-linux", "cu02", "panduan-amali", "manual-linux"]
tags: ["cu02", "linux", "noss", "amali", "standard-malaysia"]
description: "Panduan amali GPT/MBR (fdisk/parted), LVM2 (PV/VG/LV), dan sistem fail EXT4, XFS, serta Btrfs."
resource: "file:///manual/cu02/pengurusan-storan-partisi-dan-sistem-fail.md"
---

# Pengurusan Storan, Partisi & Sistem Fail Linux

## 🎯 Objektif Pembelajaran
Panduan amali GPT/MBR (fdisk/parted), LVM2 (PV/VG/LV), dan sistem fail EXT4, XFS, serta Btrfs.
...
1. *"Jelaskan langkah-langkah diagnostik keselamatan lanjut bagi modul Pengurusan Storan, Partisi & Sistem Fail Linux dalam persekitaran Linux perusahaan."*
2. *"Bagaimanakah cara mengautomasikan konfigurasi Pengurusan Storan, Partisi & Sistem Fail Linux menggunakan Ansible Playbook?"*
