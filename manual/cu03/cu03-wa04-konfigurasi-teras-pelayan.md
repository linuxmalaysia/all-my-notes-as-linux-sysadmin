...
okf_version: 0.1
type: knowledge-node
title: "Konfigurasi Teras Pelayan Linux"
timestamp: "2026-08-17T00:00:00Z"
topics: ["noss-linux", "cu03", "panduan-amali", "manual-linux"]
tags: ["cu03", "linux", "noss", "amali", "standard-malaysia"]
description: "Konfigurasi systemd, hostname, zon masa (Chrony NTP), SSH hardening, dan repositori."
resource: "file:///manual/cu03/cu03-wa04-konfigurasi-teras-pelayan.md"
---

# Konfigurasi Teras Pelayan Linux

## 🎯 Objektif Pembelajaran
Konfigurasi systemd, hostname, zon masa (Chrony NTP), SSH hardening, dan repositori.
...
1. *"Jelaskan langkah-langkah diagnostik keselamatan lanjut bagi modul Konfigurasi Teras Pelayan Linux dalam persekitaran Linux perusahaan."*
2. *"Bagaimanakah cara mengautomasikan konfigurasi Konfigurasi Teras Pelayan Linux menggunakan Ansible Playbook?"*
