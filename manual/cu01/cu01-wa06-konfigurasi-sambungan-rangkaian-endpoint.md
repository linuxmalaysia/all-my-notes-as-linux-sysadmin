...
2. Konfigurasi alamat IP secara dinamik (**DHCP**) dan statik (**Static IP**) mengikut skema IPv4 & IPv6.
3. Menyambungkan endpoint ke rangkaian tanpa wayar (*Wi-Fi*) dengan protokol keselamatan WPA2/WPA3 Enterprise.
...
### 1. Diagostik Rangkaian Asas (`iproute2` & Tools)
...
```bash
# Mengubah profil sambungan ke mod DHCP dinamik automatik
...
# 3. Menyambung ke SSID Wi-Fi berperingkat keselamatan WPA2/WPA3
sudo nmcli device wifi connect "Wi-Fi_Pejabat" password "KataLaluanSelamat2026!"
```
