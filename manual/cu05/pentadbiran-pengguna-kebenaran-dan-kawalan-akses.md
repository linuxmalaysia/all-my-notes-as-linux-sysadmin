...
> [!NOTE]
> Modul ini dipetakan daripada **Bab 4 (Pentadbiran Pengguna, Kebenaran & Pelayaran)** ke dalam Unit Kompetensi **CU05 (Kawalan Keselamatan Endpoint & Audit)** dan **CU01 (Aktiviti Asas Linux)** untuk edaran rasmi **Ubuntu 26.04 LTS "Quetzal"** dan **AlmaLinux 10 "Purple Lion"**.
...
sudo groupadd -g 2000 sysadmin_sec

# Cipta akaun pengguna baharu dengan direktori perumah dan shell Bash
sudo useradd -m -u 2001 -g 2000 -s /bin/bash -c "Ahmad Pengawas Sistem" ahmad
...
Menghadkan bilangan proses dan penggunaan memori pengguna untuk mementingkan kestabilan sistem:
```text
# Mengurangkan risiko Serangan Penafian Perkhidmatan (DoS) berasaskan fork bomb
*          hard    nproc          2048
...
```bash
# Beritahu semua pengguna dan tutup sistem secara selamat
sudo shutdown -h +5 "Sistem akan ditutup untuk penyelenggaraan dalam masa 5 minit."

# Matikan sistem serta-merta menggunakan systemd
