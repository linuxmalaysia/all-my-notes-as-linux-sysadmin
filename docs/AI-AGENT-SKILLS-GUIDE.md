...
| **Initialise GitOps** | `.agents/skills/initialise-gitops/SKILL.md` | Establishes the foundational GitOps repository and Genesis DSOM architecture. |
...
| **OKF Frontmatter Injector** | `.agents/skills/okf-frontmatter-injector/SKILL.md` | Scans a directory and automatically injects OKF v0.2 YAML frontmatter into Markdown files. |
