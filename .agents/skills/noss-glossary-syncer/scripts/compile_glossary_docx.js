/**
 * @file compile_glossary_docx.js
 * @description Highly detailed JSDoc comments for compile_glossary_docx.js.
...
const rawData = fs.readFileSync(path.join(__dirname, "../../../../noss-l3-latest/scripts/glossary_data.json"), "utf8");
    ...
    new TableRow({
      children: [
        ...
        new TableCell({
          ...
          children: [
            new Paragraph({
              children: [new TextRun({ text: item.term, font: "Times New Roman", size: 24 })],
            }),
          ],
        }),
        new TableCell({
...
Packer.toBuffer(doc).then((buffer) => {
  const outputPath = path.join(__dirname, "../../../../noss-l3-latest/addon-knowledge/glossary.docx");
  fs.writeFileSync(outputPath, buffer);
  console.log(`✅ Compiled JPK-compliant glossary.docx successfully at ${outputPath}`);
});
