...
okf_version: 0.1
type: documentation
title: "START HERE: Linux NOSS Malaysia & DSOM Entry Points"
topics: ["onboarding", "entry-points", "dsom", "sovereign", "linux", "noss", "malaysia"]
description: "The primary onboarding document for human operators and AI agents adopting the DSOM framework into the Linux NOSS Malaysia project."
---
# START HERE: Linux NOSS Malaysia & DSOM Entry Points
...
Sistem ini direka bentuk sebagai pangkalan pengetahuan Linux tidak rasmi yang berasaskan *National Occupational Skills Standard (NOSS)* Malaysia. Ia disusun rapi untuk kecekapan AI membaca konteks secara spasial dan modular.
...
Jika anda pembaca manusia, pelajar TVET, atau pentadbir sistem yang mahu mempelajari sukatan pelajaran amali Linux, berikut adalah panduan titik mula (*entry points* / panduan permulaan) untuk manual Linux:
...
2. **Laluan Mengikut Tahap & Keperluan**:
   - 🔰 **Pemula & Pengguna Baharu Desktop**:
     ...
     - Rujuk juga panduan permulaan (*onboarding*) amali di [`docs/tutorials/getting-started.md`](docs/tutorials/getting-started.md).
   ...
   - ⚙️ **Automasi, Keselamatan & Khidmat Sokongan**:
     ...
     - **Keselamatan & Pengerasan (*Hardening*)**: Rujuk [**CU05: Kawalan Keselamatan Endpoint & Hardening**](manual/cu05/index.md).
     - **Penyelesaian Masalah (*Troubleshooting*) & Log**: Rujuk [**CU06: Sokongan Pengguna & Troubleshooting**](manual/cu06/index.md).
